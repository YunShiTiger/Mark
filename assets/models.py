...
class Asset(models.Model):
    ...
    contract = models.ForeignKey('Contract', verbose_name=u'合同', null=True, blank=True, on_delete=models.DO_NOTHING)
    ...
    admin = models.ForeignKey('UserProfile', verbose_name=u'资产管理员', null=True, blank=True, on_delete=models.DO_NOTHING)
    idc = models.ForeignKey('IDC', verbose_name=u'IDC机房', null=True, blank=True, on_delete=models.DO_NOTHING)
...
class Server(models.Model):
    ...
    hosted_on = models.ForeignKey('self', related_name='hosted_on_server', blank=True, null=True,
                                  on_delete=models.DO_NOTHING)  # for vitural server
...
class NetworkDevice(models.Model):
    ...
    firmware = models.ForeignKey('Software', blank=True, null=True, on_delete=models.DO_NOTHING)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey('UserProfile', verbose_name=u'事件源', on_delete=models.DO_NOTHING)
    memo = models.TextField(u'备注', blank=True, null=True)
